  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "contact@omega.cd",
      href: "mailto:contact@omega.cd"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+243 99 699 8277",
      href: "tel:+243996998277"
    },
    {
      icon: MapPin,
      label: "Address",
      value: "8177, Quantum Building, Blvd 30 Juin, Gombe, Kinshasa",
      href: "https://maps.google.com?q=quantum%20bldg"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Our dedicated team is ready to support your success.
          </p>
        </div>
